...
public interface ProductsService {
	...
	//public Products updateProductIncatalog(Products product,int key);

	Products updateProductInCatalog(Products product, int key) throws ProductNotFoundException;
